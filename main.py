...
# MENU HANDLERS
# ============================================================
@router.message(F.text.in_({"ငွေစာရင်း", " ငွေစာရင်း"}))
...
@router.message(F.text.in_({"သူငယ်ချင်းဖိတ်မယ်", " သူငယ်ချင်းဖိတ်မယ်"}))
...
@router.message(F.text.in_({"အကူအညီ", " အကူအညီ"}))
...
@router.message(F.text.in_({"ငွေထုတ်မယ်", " ငွေထုတ်မယ်"}))
